...
public class XMLCancelamentoNFCeService implements Serializable {
	...
	public NFCe enviar(NFCe nfe) {
		...
		try {
			...
			TRetEnvEvento retorno = br.com.samuelweb.nfe.Nfe.cancelarNfe(enviEvento, false, ConstantesUtil.NFCE);
			...
			FacesUtil.addInfoMessage("NFC-e Cancelada com sucesso");
